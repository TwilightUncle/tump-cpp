#ifndef TUMP_V_0_1_0_INCLUDE_GUARD_TUMP_CONTAINERS_BTREE_HPP
#define TUMP_V_0_1_0_INCLUDE_GUARD_TUMP_CONTAINERS_BTREE_HPP
    ...
    namespace fn
    {
        namespace impl
        {
            ...
            struct push_impl : public std::type_identity<
                bnode<
                    T,
                    invoke_t<::tump_0_1_0::through_if, partial_apply<typename Comparing::lt, T>, New, mp_null_t>,
                    invoke_t<::tump_0_1_0::through_if, partial_apply<typename Comparing::ge, T>, New, mp_null_t>
                >
            > {};
