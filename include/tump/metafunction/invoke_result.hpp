...
namespace tump
{
    ...
    */
    ...
    struct invoke_result : public std::type_identity<mp_null_t> {};
    ...
    struct invoke_result<OuterF<InnerF, Args1...>, Args...> : public invoke_result<InnerF, Args...> {};
    ...
    struct invoke_result<callback<invoke_result, ArgsSize>> : public constraint_callback_arg1 {};
    ...
    */
    template <unsigned int ArgsSize>
    struct invoke_result<callback<std::is_same, ArgsSize>> : public constraint_bool_constant {};
    template <unsigned int ArgsSize>
    struct invoke_result<callback<std::is_integral, ArgsSize>> : public constraint_bool_constant {};
    template <unsigned int ArgsSize>
    struct invoke_result<callback<std::is_floating_point, ArgsSize>> : public constraint_bool_constant {};

    /**
     * tump内の結果型について指定
    */
    template <unsigned int ArgsSize>
    struct invoke_result<callback<is_empty, ArgsSize>> : public constraint_bool_constant {};
}
