#ifndef TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_COMPARE_HPP
#define TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_COMPARE_HPP

#include TUMP_V_0_1_2_COMMON_INCLUDE(algorithm/to_true.hpp)
...
namespace tump_0_1_2
{
    namespace fn
    {
        ...
        template <InvocableArgN<2> Compare, InvocableArgN<1> Constraint = ::tump_0_1_2::to_true>
    ...
    namespace fn
    {
        ...
        */
        ...
        template <InvocableArgN<2> Compare, InvocableArgN<1> Constraint>
        struct is_comparing_type<::tump_0_1_2::comparing_type<Compare, Constraint>> : public std::true_type {};
