#ifndef TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_UNIQUE_HPP
#define TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_UNIQUE_HPP
    ...
    namespace fn
    {
        namespace impl
        {
            ...
            using unique = push_back_if<
                compose_t<
                    negation,
                    partial_apply<::tump_0_1_2::flip, ::tump_0_1_2::exists, Acc>
                >,
                Acc,
                Cur
            >;
