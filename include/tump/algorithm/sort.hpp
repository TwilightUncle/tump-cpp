#ifndef TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_SORT_HPP
#define TUMP_V_0_1_2_INCLUDE_GUARD_TUMP_ALGORITHM_SORT_HPP
    ...
    namespace fn
    {
        ...
        */
        ...
        struct sort : public invoke<
            compose_t<
                partial_apply<::tump_0_1_2::unnorm_li, List>,
                ::tump_0_1_2::flatten,
                partial_apply<
                    ::tump_0_1_2::flip,
                    ::tump_0_1_2::to_bintree,
                    Comparing
                >
            >,
            List
